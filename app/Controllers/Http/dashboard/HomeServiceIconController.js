...
class HomeServiceIconController {
    async index ({auth, view}) {
        ...
        return view.render("dashboard.home-service-icon.index", {list: data})
    }
    ...
    async show ( { auth, params, view } ) {
        ...
        return view.render("dashboard.home-service-icon.show", {data: data})
    }
...
module.exports = HomeServiceIconController
